...
public class FilesPagerAdapter extends FragmentPagerAdapter {
    ...
    public FilesPagerAdapter(@NonNull final Context context, final FragmentManager fragmentManager) {
        super(fragmentManager);
        mContext = context;
        setCategoryInfos(PreferenceUtil.getInstance(context).getDefaultFileCategoryInfos());
    }
    ...
    public void setCategoryInfos(@NonNull ArrayList<CategoryInfo> categoryInfos) {
        ...
        for (CategoryInfo categoryInfo : categoryInfos) {
            if (categoryInfo.visible) {
                FileEnumFragments fragment = FileEnumFragments.valueOf(categoryInfo.fileCategory.toString());
                Holder holder = new Holder();
                holder.mClassName = fragment.getFragmentClass().getName();
                holder.title = mContext.getResources()
                        .getString(categoryInfo.fileCategory.stringRes)
    ...
    public long getItemId(int position) {
        ...
        return FileEnumFragments.of(getFragment(position).getClass()).ordinal();
    }
    ...
    public enum FileEnumFragments {
        ...
        FileEnumFragments(final Class<? extends Fragment> fragmentClass) {
        ...
        public static FileEnumFragments of(Class<?> cl) {
            FileEnumFragments[] fragments = All.FRAGMENTS;
            ...
            throw new IllegalArgumentException("Unknown file enum fragment " + cl);
        }
