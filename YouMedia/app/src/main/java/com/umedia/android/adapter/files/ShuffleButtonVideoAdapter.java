 ...
 * @author Lee (zh)
 */
public class ShuffleButtonVideoAdapter extends AbsOffsetVideoAdapter {

    public ShuffleButtonVideoAdapter(AppCompatActivity activity, ArrayList<FileInfo> dataSet, @LayoutRes int itemLayoutRes, boolean usePalette, @Nullable CabHolder cabHolder) {
        super(activity, dataSet, itemLayoutRes, usePalette, cabHolder);
    }

    @Override
    protected VideoAdapter.ViewHolder createViewHolder(View view) {
        return new ShuffleButtonVideoAdapter.ViewHolder(view);
    }
    ...
    public class ViewHolder extends AbsOffsetVideoAdapter.ViewHolder {
