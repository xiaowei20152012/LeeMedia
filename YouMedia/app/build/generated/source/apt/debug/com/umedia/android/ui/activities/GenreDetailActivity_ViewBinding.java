...
public class GenreDetailActivity_ViewBinding extends AbsSlidingMusicPanelActivity_ViewBinding {
  ...
  @UiThread
  public GenreDetailActivity_ViewBinding(GenreDetailActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public GenreDetailActivity_ViewBinding(GenreDetailActivity target, View source) {
    super(target, source);
  ...
  @Override
  public void unbind() {
    GenreDetailActivity target = this.target;
